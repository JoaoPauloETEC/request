    <div id="modalSec" class="modal modal-fixed-footer">
      <div class="modal-content" id="modalStyleSec">
        <button href="#!" class="modal-close waves-effect waves-green" id="agreeButton">Agree</button>
        <div class="container">
          <div class="row">
            <div class="col l7 m7 s7">
              <h1 class="center-align" id="titleSec">Meus dados</h1>
            </div>
            ...
            <div class="col l12 m10 s12">
              <div class="form-goup">
                ...
                <div class="col l9 m9 s12">
                  <input type="text" placeholder="Nome do Secretário" class="input form-control" id="inputEstiloNm" disabled>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col l12 m10 s12">
              <div class="form-goup">
                ...
                <div class="col l9 m9 s12">
                  <input type="text" placeholder="E-mail do Secretário" class="input form-control" id="inputEstiloEm" disabled>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-footer" id="modalFooSec">
